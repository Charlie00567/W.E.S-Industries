...
function App() {
  ...
  const buttons = document.querySelectorAll(".faceio_button");

  // Iterar sobre cada botón y quitar la clase 'active' de cada uno
  buttons.forEach(button => {
    button.classList.remove("active");
  });

  const clases = document.querySelectorAll(".componentes");
